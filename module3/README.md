...
오픈 소스 프로그램 오피스는 사업부가 계획에서 오픈 소스를 고려하기 시작할 때 대화에 실체와 사실을 제공하므로 고려되는 이유, 결과가 무엇인지, 목표를 달성하기 위해 무엇이 필요한지 완전히 이해할 수 있습니다. 오픈 소스 전문가가 대화를 구성하는데 도움을 줌으로써 이해 관계자는 결정을 내릴 때 어디서부터 시작하고 무엇을 생각할지 알 수 있습니다.
...
이러한 질문에 대한 답변은 향후 정책 및 프로세스에 대한 정보를 제공하는데 도움이 됩니다. 다음 페이지에서 이러한 정책의 몇 가지 예를 다룰 것입니다.
