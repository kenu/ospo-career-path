...
오픈 소스 프로젝트가 조직의 '무료 개발자'가 아니라는 점을 이해하는 것은 매우 중요합니다. 그렇게 가정하면 나중에 문제가 될 수 있습니다. 다음 몇 페이지에서 우리는 오픈 소스 커뮤니티에 참여하기 위한 몇 가지 모범 사례를 제공하고 일부 기본 커뮤니케이션 도구 에티켓이 이러한 대규모 분산 개발 팀과 효과적으로 작업하는데 도움이 되는 방법을 보여줍니다.
...
* 이러한 개념을 구현하는데 드는 비용과 이점을 명확히 합니다.
